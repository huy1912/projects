...
public class LISIntegrationWebservice extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/HUY/git/labs/rims-lab-quantum/src/main/resources/wsdl/LisIntegrationWebservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LISIntegrationWebservice.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/HUY/git/labs/rims-lab-quantum/src/main/resources/wsdl/LisIntegrationWebservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
